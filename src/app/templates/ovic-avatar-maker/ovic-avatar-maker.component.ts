...
import { UnsubscribeOnDestroy } from '@utilities/decorator';
import { NotificationService } from '@theme/services/notification.service';
import { BUTTON_YES, BUTTON_NO } from '@model/button';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { AuthService } from '@service/core/auth.service';
import { FileService } from '@service/core/file.service';
import { SafeUrlPipe } from '../../pipes/safe-url.pipe';
import { AvatarMaker } from '@service/core/media.service';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, ImageCropperModule, SafeUrlPipe, SafeResourceUrlPipe]
})
  ...
  imageCropped( event : ImageCroppedEvent ) {
	...
	async cancelAct() {
		try {
			...
			// const button = await this.notificationService.( body , head , [ BUTTON_YES , BUTTON_NO ] );
